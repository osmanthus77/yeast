...
OUTPUT_JSON="$WORK_DIR/duplicated_regions.json"
OUTPUT_RG="$WORK_DIR/duplicated_regions.rg"
...
echo "==> Step 6: json convert to rg"
# convert json file to range file
spanr convert "$OUTPUT_JSON" -o "$OUTPUT_RG"

echo "Success! Duplicated regions saved to $OUTPUT_RG"
